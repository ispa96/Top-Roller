...
public class Utils {
    ...
    /*public static void switchScenes(ActionEvent event, String toScene, String player1Username, String player2Username) {
        try {
            ...
            if(player1Username != null && player2Username != null && controller != null) {
                try{
                    Method setUsernameMethod = controller.getClass().getMethod("setPlayers", String.class, String.class);
                    setUsernameMethod.invoke(controller, player1Username, player2Username);
                }
                catch (Exception e) {
                    e.printStackTrace();
                }
